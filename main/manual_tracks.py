# manual_tracks.py
# Edit this file to add manual tracks. Both qr_on_bg.py and text_on_bg.py will import this list.
# Each entry: {"year": "2023", "artist": "Artist Name", "title": "Song Title", "url": "https://youtube.com/..."}
